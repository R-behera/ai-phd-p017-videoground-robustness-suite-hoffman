# PrivacyStress ML Suite: Computer vision for Hoffman-Aligned Research

A professor-outreach research proposal aligned with **Judy Hoffman** at **Georgia Institute of Technology**.
...
This repo has its own runnable prototype method: **HoffmanFailureFirstComputerVisionDistillLoop**.
...
How can a focused, reproducible artifact around **Computer vision** create useful research infrastructure for a lab working on **Computer vision + ML, domain adaptation, robustness, fairness**?
...
- **CSV research area:** Computer vision + ML, domain adaptation, robustness, fairness
- **Representative paper:** CyCADA: Cycle-Consistent Adversarial Domain Adaptation; 2018; ICML
- **Scholar link:** https://scholar.google.com/scholar?q=CyCADA%3A+Cycle-Consistent+Adversarial+Domain+Adaptation
