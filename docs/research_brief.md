...
VideoGround Robustness Suite: Computer vision for Hoffman-Aligned Research

## Motivation

This project targets the intersection of **Computer vision + ML, domain adaptation, robustness, fairness** and PhD-level research readiness. The goal is to produce a publishable-style artifact with a clear claim, reproducible experiments, and an honest account of failures.
...
2. Add one measurable method or evaluation contribution tied to Judy Hoffman's research area.
...
Advisor-specific slice: **Computer vision + ML, domain adaptation, robustness, fairness**.
