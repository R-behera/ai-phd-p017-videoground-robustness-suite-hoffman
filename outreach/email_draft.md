...
**Subject:** Prospective PhD applicant interested in trustworthy and robust AI evaluation (Computer vision)

Dear Professor Hoffman,

I am preparing for Fall 2027 PhD applications and have been studying your work around **Computer vision + ML, domain adaptation, robustness, fairness**. I was especially interested in the direction represented by **CyCADA: Cycle-Consistent Adversarial Domain Adaptation; 2018; ICML**.

I put together a small research scaffold for a project I would like to develop further: **PrivacyStress ML Suite: Computer vision for Hoffman-Aligned Research**. The goal is to build **an adaptive red-team and repair harness for robustness, safety, privacy, or fairness failures** focused on **Computer vision**, with reproducible baselines, ablations, and failure analysis rather than a demo-only implementation.
...
Private repo URL for your own reference: https://github.com/R-behera/ai-phd-p017-videoground-robustness-suite-hoffman
