...
METHOD_SPEC = {
    "algorithm_id": "P017-Hoffman-ComputerVision",
    "algorithm_name": "HoffmanFailureFirstComputerVisionDistillLoop",
    ...
    "decision_rule": "Rank seed cases by trustworthy-specific priority score with Hoffman-aligned focus term 'Computer vision'.",
